...
var _user$project$SharedModels$ChartPt = F2(
	function (a, b) {
		return {x: a, y: b};
	});
var _user$project$SharedModels$ChartVal = F2(
	function (a, b) {
		return {id: a, value: b};
	});
var _user$project$SharedModels$RoutedTanks = F3(
	function (a, b, c) {
		return {manual: a, noreadings: b, low: c};
	});

var _user$project$ReadingAPI$encodeReadingWrite = function (x) {
	...
	return _elm_lang$core$Json_Encode$object(
		_elm_lang$core$Native_List.fromArray(
			[
				...
				ctor: '_Tuple2',
				_0: 'value',
				_1: _elm_lang$core$Json_Encode$float(x.readingValue)
			},
				{
				ctor: '_Tuple2',
				_0: 'dbreceived',
				...
				_1: function (_p3) {
					return _elm_lang$core$Json_Encode$string(
						_krisajenkins$elm_exts$Exts_Date$toISOString(
...
var _user$project$ReadingAPI$decodeReadingRead = A2(
	...
	A2(
		...
		A2(
			...
			A2(
				...
				A2(
					_elm_community$json_extra$Json_Decode_Extra_ops['|:'],
					_elm_lang$core$Json_Decode$succeed(_user$project$ReadingAPI$ReadingRead),
...
var _user$project$ReadingAPI$get = function () {
	var request = {
		verb: 'GET',
		headers: _elm_lang$core$Native_List.fromArray(
			[
...
var _user$project$ReadingAPI$getByTank = F3(
	function (tank, mseconds, mreading) {
		var queries = function () {
			var _p5 = {ctor: '_Tuple2', _0: mseconds, _1: mreading};
...
var _user$project$ReadingAPI$decodeReadingWrite = A2(
	_elm_community$json_extra$Json_Decode_Extra_ops['|:'],
	A2(
		_elm_community$json_extra$Json_Decode_Extra_ops['|:'],
		A2(
			...
			A2(
				...
				A2(
					_elm_community$json_extra$Json_Decode_Extra_ops['|:'],
					_elm_lang$core$Json_Decode$succeed(_user$project$ReadingAPI$ReadingWrite),
					A2(
						_elm_lang$core$Json_Decode_ops[':='],
						'id',
						_elm_lang$core$Json_Decode$maybe(_elm_lang$core$Json_Decode$int))),
...
var _user$project$Chart$chartLocation = function (chart) {
	return _elm_lang$core$Basics$toString(chart.id);
};
var _user$project$Chart$minLen = function (x) {
	return (_elm_lang$core$Native_Utils.cmp(x, 10) < 0) ? A2(
		_elm_lang$core$Basics_ops['++'],
		'0',
		_elm_lang$core$Basics$toString(x)) : _elm_lang$core$Basics$toString(x);
};
var _user$project$Chart$showDate = function (date) {
	var dy = _elm_lang$core$Basics$toString(
		_elm_lang$core$Date$day(date));
	var mt = _elm_lang$core$Basics$toString(
		_elm_lang$core$Date$month(date));
	var yr = _elm_lang$core$Basics$toString(
		_elm_lang$core$Date$year(date));
	var mn = _user$project$Chart$minLen(
		_elm_lang$core$Date$minute(date));
	var hr = _user$project$Chart$minLen(
					...
					A2(
						...
						A2(
							...
							A2(
								_elm_lang$core$Basics_ops['++'],
								hr,
								A2(_elm_lang$core$Basics_ops['++'], ':', mn))))))));
};
var _user$project$Chart$color = F3(
	function (red, yellow, val) {
		return (_elm_lang$core$Native_Utils.cmp(val, yellow) < 1) ? 'green' : ((_elm_lang$core$Native_Utils.cmp(val, red) < 1) ? 'yellow' : 'red');
	});
var _user$project$Chart$getRange = function (arr) {
	var _p0 = A3(
		_elm_lang$core$List$foldl,
		F2(
			function (x, _p1) {
				var _p2 = _p1;
				var nmax = A2(_elm_lang$core$Basics$max, _p2._1, x);
				var nmin = A2(_elm_lang$core$Basics$min, _p2._0, x);
...
var _user$project$Chart$takeAvg = 5;
var _user$project$Chart$empty = 1.0;
var _user$project$Chart$chartToLevel = function (chart) {
	var size = chart.numValues;
	var back = A2(
		_elm_lang$core$Basics$max,
		0.0,
		_elm_lang$core$Basics$toFloat((size - _user$project$Chart$takeAvg) - 1));
	var numTaken = _elm_lang$core$Basics$toFloat(size) - back;
	var latestFive = A2(
		_elm_lang$core$List$take,
		_elm_lang$core$Basics$round(numTaken),
		chart.values);
	var avgVal = A3(
		_elm_lang$core$List$foldr,
		F2(
		...
		0,
		latestFive) / numTaken;
	var lvl = _elm_lang$core$Native_Utils.eq(
		_elm_lang$core$Basics$round(numTaken),
		0) ? 'noreadings' : ((_elm_lang$core$Native_Utils.cmp(avgVal, _user$project$Chart$empty) < 1) ? 'empty' : ((_elm_lang$core$Native_Utils.cmp(avgVal, chart.red) < 1) ? 'red' : ((_elm_lang$core$Native_Utils.cmp(avgVal, chart.yellow) < 1) ? 'yellow' : 'green')));
	return {ctor: '_Tuple2', _0: chart.id, _1: lvl};
};
var _user$project$Chart$toggleManual = F2(
	function (cid, chart) {
		return _elm_lang$core$Native_Utils.eq(chart.id, cid) ? _elm_lang$core$Native_Utils.update(
			chart,
			{
				manual: _elm_lang$core$Basics$not(chart.manual)
			}) : chart;
	});
var _user$project$Chart$clearChart = function (chart) {
	return _elm_lang$core$Native_Utils.update(
		chart,
		{
			values: _elm_lang$core$Native_List.fromArray(
				[]),
			numValues: 0,
			lastPulled: _elm_lang$core$Maybe$Nothing,
			earliestDate: _elm_lang$core$Maybe$Nothing,
			latestDate: _elm_lang$core$Maybe$Nothing
		});
};
var _user$project$Chart$addReadings = F3(
	function (id, vals, chart) {
		if (!_elm_lang$core$Native_Utils.eq(chart.id, id)) {
			return chart;
		} else {
			var reversed = _elm_lang$core$List$reverse(vals);
			var latestReading = _elm_lang$core$List$head(reversed);
			var lastPulled = A2(
				_elm_lang$core$Maybe$map,
				function (_) {
					return _.readingId;
			...
			var latestDate = A2(
				_elm_lang$core$Maybe$map,
				function (_) {
					return _.readingDbReceived;
				},
				latestReading);
			var newVals = A2(
				_elm_lang$core$List$map,
				function (v) {
					return {x: v.readingSensorSent, y: v.readingValue};
				},
				reversed);
			var earliestReading = _elm_lang$core$List$head(vals);
			var earliestDate = A2(
				_elm_lang$core$Maybe$map,
				function (_) {
					return _.readingDbReceived;
			...
			return _elm_lang$core$Native_Utils.update(
				chart,
				{
					values: A2(_elm_lang$core$Basics_ops['++'], newVals, chart.values),
					numValues: chart.numValues + _elm_lang$core$List$length(vals),
					lastPulled: _elm_lang$core$Maybe$oneOf(
						_elm_lang$core$Native_List.fromArray(
							[lastPulled, chart.lastPulled])),
					latestDate: _elm_lang$core$Maybe$oneOf(
						_elm_lang$core$Native_List.fromArray(
							[latestDate, chart.latestDate])),
					earliestDate: _elm_lang$core$Maybe$oneOf(
						_elm_lang$core$Native_List.fromArray(
							[chart.earliestDate, earliestDate]))
				});
		}
	});
var _user$project$Chart$Chart = function (a) {
	return function (b) {
		return function (c) {
			return function (d) {
				return function (e) {
					return function (f) {
						return function (g) {
							return function (h) {
								return function (i) {
									return function (j) {
										return {id: a, pos: b, values: c, numValues: d, yellow: e, red: f, lastPulled: g, earliestDate: h, latestDate: i, manual: j};
									};
								};
							};
						};
...
var _user$project$GMPorts$addMarker = _elm_lang$core$Native_Platform.incomingPort(
	'addMarker',
	A5(
		...
		_elm_lang$core$Json_Decode$float));
var _user$project$GMPorts$markerClicked = _elm_lang$core$Native_Platform.incomingPort('markerClicked', _elm_lang$core$Json_Decode$int);
var _user$project$GMPorts$markerDblClicked = _elm_lang$core$Native_Platform.incomingPort('markerDblClicked', _elm_lang$core$Json_Decode$int);
var _user$project$GMPorts$addHub = _elm_lang$core$Native_Platform.outgoingPort(
	'addHub',
	function (v) {
		return {lat: v.lat, lng: v.lng};
	});
var _user$project$GMPorts$addTank = _elm_lang$core$Native_Platform.outgoingPort(
	'addTank',
	function (v) {
		return [
			v._0,
			{lat: v._1.lat, lng: v._1.lng},
			v._2,
			v._3
		];
	});
var _user$project$GMPorts$setColor = _elm_lang$core$Native_Platform.outgoingPort(
	'setColor',
	function (v) {
		return [v._0, v._1, v._2];
	});
var _user$project$GMPorts$sendRoutes = _elm_lang$core$Native_Platform.outgoingPort(
	'sendRoutes',
	function (v) {
		return {
			manual: _elm_lang$core$Native_List.toArray(v.manual).map(
				function (v) {
					return v;
				}),
			noreadings: _elm_lang$core$Native_List.toArray(v.noreadings).map(
				function (v) {
					return v;
				}),
			low: _elm_lang$core$Native_List.toArray(v.low).map(
				function (v) {
					return v;
				})
		};
...
var _user$project$HubAPI$encodeHubWrite = function (x) {
	return _elm_lang$core$Json_Encode$object(
		_elm_lang$core$Native_List.fromArray(
			[
				{
...
var _user$project$HubAPI$post = function (body) {
	var request = {
		verb: 'POST',
		headers: _elm_lang$core$Native_List.fromArray(
			[
		...
		body: _evancz$elm_http$Http$string(
			A2(
				_elm_lang$core$Json_Encode$encode,
				0,
				_user$project$HubAPI$encodeHubWrite(body)))
	};
	return A2(
		_evancz$elm_http$Http$fromJson,
		_elm_lang$core$Json_Decode$maybe(_elm_lang$core$Json_Decode$int),
...
var _user$project$HubAPI$encodeHubRead = function (x) {
	return _elm_lang$core$Json_Encode$object(
		_elm_lang$core$Native_List.fromArray(
			[
				{
...
var _user$project$HubAPI$HubRead = F4(
	function (a, b, c, d) {
		return {hubId: a, hubName: b, hubLat: c, hubLng: d};
	});
var _user$project$HubAPI$decodeHubRead = A2(
	_elm_community$json_extra$Json_Decode_Extra_ops['|:'],
	A2(
		_elm_community$json_extra$Json_Decode_Extra_ops['|:'],
		A2(
			...
			A2(
				_elm_community$json_extra$Json_Decode_Extra_ops['|:'],
				_elm_lang$core$Json_Decode$succeed(_user$project$HubAPI$HubRead),
				A2(_elm_lang$core$Json_Decode_ops[':='], 'id', _elm_lang$core$Json_Decode$int)),
			A2(_elm_lang$core$Json_Decode_ops[':='], 'name', _elm_lang$core$Json_Decode$string)),
		A2(_elm_lang$core$Json_Decode_ops[':='], 'lat', _elm_lang$core$Json_Decode$float)),
	A2(_elm_lang$core$Json_Decode_ops[':='], 'lng', _elm_lang$core$Json_Decode$float));
var _user$project$HubAPI$get = function () {
	var request = {
		verb: 'GET',
		headers: _elm_lang$core$Native_List.fromArray(
			[
	...
	return A2(
		_evancz$elm_http$Http$fromJson,
		_elm_lang$core$Json_Decode$list(_user$project$HubAPI$decodeHubRead),
		A2(_evancz$elm_http$Http$send, _evancz$elm_http$Http$defaultSettings, request));
}();
var _user$project$HubAPI$getById = function (id) {
	var request = {
		verb: 'GET',
		headers: _elm_lang$core$Native_List.fromArray(
			[
	...
	return A2(
		_evancz$elm_http$Http$fromJson,
		_elm_lang$core$Json_Decode$maybe(_user$project$HubAPI$decodeHubRead),
		A2(_evancz$elm_http$Http$send, _evancz$elm_http$Http$defaultSettings, request));
};
var _user$project$HubAPI$HubWrite = F4(
	function (a, b, c, d) {
		return {hubId: a, hubName: b, hubLat: c, hubLng: d};
	});
var _user$project$HubAPI$decodeHubWrite = A2(
	_elm_community$json_extra$Json_Decode_Extra_ops['|:'],
	A2(
		_elm_community$json_extra$Json_Decode_Extra_ops['|:'],
		A2(
			...
			A2(
				_elm_community$json_extra$Json_Decode_Extra_ops['|:'],
				_elm_lang$core$Json_Decode$succeed(_user$project$HubAPI$HubWrite),
				A2(
					_elm_lang$core$Json_Decode_ops[':='],
					'id',
					_elm_lang$core$Json_Decode$maybe(_elm_lang$core$Json_Decode$int))),
...
var _user$project$TankAPI$encodeTankWrite = function (x) {
	return _elm_lang$core$Json_Encode$object(
		_elm_lang$core$Native_List.fromArray(
			[
				{
...
var _user$project$TankAPI$post = function (body) {
	var request = {
		verb: 'POST',
		headers: _elm_lang$core$Native_List.fromArray(
			[
		...
		body: _evancz$elm_http$Http$string(
			A2(
				_elm_lang$core$Json_Encode$encode,
				0,
				_user$project$TankAPI$encodeTankWrite(body)))
	};
	return A2(
		_evancz$elm_http$Http$fromJson,
		_elm_lang$core$Json_Decode$maybe(_elm_lang$core$Json_Decode$int),
...
var _user$project$TankAPI$getNotifications = function () {
	...
	var getString = function (val) {
		...
		if (_p1.ctor === 'Text') {
			...
			return _elm_lang$core$Native_Utils.crashCase(
				...
				_p1)('Can\'t decode notifications');
		}
	};
	var request = {
		verb: 'GET',
...
var _user$project$TankAPI$encodeTankRead = function (x) {
	return _elm_lang$core$Json_Encode$object(
		_elm_lang$core$Native_List.fromArray(
			[
				{
				...
				ctor: '_Tuple2',
				_0: 'yellow',
				_1: _elm_lang$core$Json_Encode$float(x.tankYellow)
			},
				{
				ctor: '_Tuple2',
				_0: 'red',
				_1: _elm_lang$core$Json_Encode$float(x.tankRed)
			},
				{
				ctor: '_Tuple2',
				_0: 'lat',
			...
			A2(
				...
				A2(
					...
					A2(
						...
						A2(
							_elm_community$json_extra$Json_Decode_Extra_ops['|:'],
							_elm_lang$core$Json_Decode$succeed(_user$project$TankAPI$TankRead),
							A2(_elm_lang$core$Json_Decode_ops[':='], 'id', _elm_lang$core$Json_Decode$int)),
						A2(_elm_lang$core$Json_Decode_ops[':='], 'hub', _elm_lang$core$Json_Decode$int)),
					A2(_elm_lang$core$Json_Decode_ops[':='], 'name', _elm_lang$core$Json_Decode$string)),
				A2(_elm_lang$core$Json_Decode_ops[':='], 'yellow', _elm_lang$core$Json_Decode$float)),
			A2(_elm_lang$core$Json_Decode_ops[':='], 'red', _elm_lang$core$Json_Decode$float)),
		A2(_elm_lang$core$Json_Decode_ops[':='], 'lat', _elm_lang$core$Json_Decode$float)),
	A2(_elm_lang$core$Json_Decode_ops[':='], 'lng', _elm_lang$core$Json_Decode$float));
var _user$project$TankAPI$get = function () {
	var request = {
		verb: 'GET',
		headers: _elm_lang$core$Native_List.fromArray(
			[
	...
	return A2(
		_evancz$elm_http$Http$fromJson,
		_elm_lang$core$Json_Decode$list(_user$project$TankAPI$decodeTankRead),
		A2(_evancz$elm_http$Http$send, _evancz$elm_http$Http$defaultSettings, request));
}();
var _user$project$TankAPI$getById = function (id) {
	var request = {
		verb: 'GET',
		headers: _elm_lang$core$Native_List.fromArray(
			[
	...
	return A2(
		_evancz$elm_http$Http$fromJson,
		_elm_lang$core$Json_Decode$maybe(_user$project$TankAPI$decodeTankRead),
		A2(_evancz$elm_http$Http$send, _evancz$elm_http$Http$defaultSettings, request));
};
var _user$project$TankAPI$getByHub = function (hub) {
	var request = {
		verb: 'GET',
		headers: _elm_lang$core$Native_List.fromArray(
			[
...
var _user$project$TankAPI$TankWrite = F7(
	function (a, b, c, d, e, f, g) {
		return {tankId: a, tankHub: b, tankName: c, tankYellow: d, tankRed: e, tankLat: f, tankLng: g};
	});
var _user$project$TankAPI$decodeTankWrite = A2(
	_elm_community$json_extra$Json_Decode_Extra_ops['|:'],
	A2(
		_elm_community$json_extra$Json_Decode_Extra_ops['|:'],
		A2(
			...
			A2(
				...
				A2(
					...
					A2(
						...
						A2(
							_elm_community$json_extra$Json_Decode_Extra_ops['|:'],
							_elm_lang$core$Json_Decode$succeed(_user$project$TankAPI$TankWrite),
							A2(
								_elm_lang$core$Json_Decode_ops[':='],
								'id',
								_elm_lang$core$Json_Decode$maybe(_elm_lang$core$Json_Decode$int))),
...
var _user$project$Propane$yoffset = 0;
var _user$project$Propane$xoffset = 15;
var _user$project$Propane$maxY = 4096;
var _user$project$Propane$svgHeight = 400;
var _user$project$Propane$ystep = (_user$project$Propane$svgHeight - _user$project$Propane$yoffset) / _user$project$Propane$maxY;
var _user$project$Propane$svgWidth = 600;
...
var _user$project$Propane$initialModel = {
	...
	chartsToRead: _elm_lang$core$Set$empty
};
var _user$project$Propane$zip = F2(
	function (xs, ys) {
		var _p1 = {ctor: '_Tuple2', _0: xs, _1: ys};
		if (_p1._0.ctor === '[]') {
			return _elm_lang$core$Native_List.fromArray(
				[]);
		} else {
			if (_p1._1.ctor === '[]') {
				...
				return A2(
					...
					A2(_user$project$Propane$zip, _p1._0._1, _p1._1._1));
			}
		}
	});
var _user$project$Propane$renderVals = function (chart) {
	var getDate = function (_p2) {
		return _elm_lang$html$Html$text(
			A2(
				_elm_lang$core$Maybe$withDefault,
				'',
				A2(_elm_lang$core$Maybe$map, _user$project$Chart$showDate, _p2)));
	};
	var leftX = A2(
	...
	var yvals = A2(
		...
		vals);
	var _p3 = _user$project$Chart$getRange(yvals);
	var minYVal = _p3._0;
	var maxYVal = _p3._1;
	var bottom = (_user$project$Propane$svgHeight - (minYVal * _user$project$Propane$ystep)) - (_user$project$Propane$ystep / 2);
	var top = (_user$project$Propane$svgHeight - ((maxYVal + 1) * _user$project$Propane$ystep)) + (_user$project$Propane$ystep / 2);
	var leftBar = A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[]));
	var ypts = A2(_elm_lang$core$List$map, calcY, yvals);
	var ymarginals = A2(
		_elm_lang$core$List$map,
		function (y) {
			return A2(
	...
	var xvals = A2(
		...
		vals);
	var numVals = _elm_lang$core$List$length(xvals);
	var _p4 = _user$project$Chart$getRange(xvals);
	var minXVal = _p4._0;
	var maxXVal = _p4._1;
	var maxX = (maxXVal - minXVal) + _user$project$Propane$xoffset;
	var xstep = (_user$project$Propane$svgWidth - _user$project$Propane$xoffset) / maxX;
	var left = _user$project$Propane$xoffset - (xstep / 4);
	var xSize = maxX * xstep;
	var right = (xSize + _user$project$Propane$xoffset) - xstep;
	var bottomBar = A2(
		_elm_lang$svg$Svg$line,
		_elm_lang$core$Native_List.fromArray(
			[
	...
	var rightX = A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_elm_lang$core$Basics$toString(xSize)),
				_elm_lang$svg$Svg_Attributes$y('20'),
	...
	var calcX = function (x) {
		return ((xstep * (x - minXVal)) + (xstep / 2)) + _user$project$Propane$xoffset;
	};
	var xpts = A2(_elm_lang$core$List$map, calcX, xvals);
	var xmarginals = A2(
		_elm_lang$core$List$map,
		function (x) {
			return A2(
		...
		xpts);
	var marginals = A2(_elm_lang$core$Basics_ops['++'], ymarginals, xmarginals);
	var pts = A2(
		_elm_lang$core$List$map,
		function (_p5) {
			var _p6 = _p5;
		...
		A2(_user$project$Propane$zip, xpts, ypts));
	var lines = function () {
		if (_elm_lang$core$List$isEmpty(ypts)) {
			return _elm_lang$core$Native_List.fromArray(
				[]);
		} else {
			var ax = A2(
				_elm_lang$core$Maybe$withDefault,
				-1,
				_elm_lang$core$List$head(xpts));
			var ay = A2(
				_elm_lang$core$Maybe$withDefault,
				-1,
				_elm_lang$core$List$head(ypts));
									...
									A2(
										...
										_elm_lang$core$Native_List.fromArray(
											[
												...
												_elm_lang$svg$Svg_Attributes$y1(
												_elm_lang$core$Basics$toString(_p11._1._1)),
												_elm_lang$svg$Svg_Attributes$y2(
										...
										_elm_lang$core$Native_List.fromArray(
											[])),
									_p11._0),
								_1: {ctor: '_Tuple2', _0: _p12, _1: _p13}
							};
						}),
					{
						ctor: '_Tuple2',
	...
	var allTogether = A2(
		...
		A2(
			...
			A2(
				_elm_lang$core$Basics_ops['++'],
				marginals,
				A2(_elm_lang$core$Basics_ops['++'], lines, pts))));
	return A2(
...
var _user$project$Propane$Model = F6(
	function (a, b, c, d, e, f) {
		return {charts: a, numCharts: b, currChart: c, timeScale: d, includeNoReadings: e, chartsToRead: f};
	});
var _user$project$Propane$SlowTick = function (a) {
	return {ctor: 'SlowTick', _0: a};
};
var _user$project$Propane$FastTick = function (a) {
	return {ctor: 'FastTick', _0: a};
};
var _user$project$Propane$RouteYellow = {ctor: 'RouteYellow'};
var _user$project$Propane$RouteRed = {ctor: 'RouteRed'};
var _user$project$Propane$ToggleNoReadings = {ctor: 'ToggleNoReadings'};
var _user$project$Propane$NewReading = function (a) {
	return {ctor: 'NewReading', _0: a};
};
var _user$project$Propane$ToggleManual = function (a) {
	return {ctor: 'ToggleManual', _0: a};
};
var _user$project$Propane$ChangeScale = function (a) {
	return {ctor: 'ChangeScale', _0: a};
};
var _user$project$Propane$Failure = function (a) {
	return {ctor: 'Failure', _0: a};
};
var _user$project$Propane$AddReadings = F2(
	function (a, b) {
		return {ctor: 'AddReadings', _0: a, _1: b};
	});
var _user$project$Propane$AddTanks = function (a) {
	return {ctor: 'AddTanks', _0: a};
};
		...
		switch (_p14.ctor) {
			case 'ClearChart':
				...
				var newCharts = A2(
					_elm_lang$core$List$map,
					function (c) {
						return _elm_lang$core$Native_Utils.eq(c.id, _p15) ? _user$project$Chart$clearChart(c) : c;
					},
					model.charts);
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						...
						{
							charts: newCharts,
							chartsToRead: A2(_elm_lang$core$Set$insert, _p15, model.chartsToRead)
						}),
				...
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							...
							numCharts: newCt,
							chartsToRead: A2(_elm_lang$core$Set$insert, _p16, model.chartsToRead)
						}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'MarkerClicked':
				...
				if (_p17.ctor === 'Nothing') {
					...
					return {
						...
						_1: _elm_lang$core$Platform_Cmd$batch(
							_elm_lang$core$Native_List.fromArray(
								[
									_user$project$GMPorts$addHub(
									{lat: _p18.hubLat, lng: _p18.hubLng}),
									A3(
									_elm_lang$core$Task$perform,
									_user$project$Propane$Failure,
									_user$project$Propane$AddTanks,
									_user$project$TankAPI$getByHub(1))
								]))
					};
				}
			case 'AddTanks':
				return {
					...
					_1: _elm_lang$core$Platform_Cmd$batch(
						A2(
							_elm_lang$core$List$map,
							function (t) {
								return _user$project$GMPorts$addTank(
									{
										ctor: '_Tuple4',
										_0: t.tankId,
										_1: {lat: t.tankLat, lng: t.tankLng},
										_2: t.tankYellow,
										_3: t.tankRed
									});
							},
			...
			case 'AddReadings':
				...
				var newCharts = A2(
					_elm_lang$core$List$map,
					A2(_user$project$Chart$addReadings, _p19, _p14._1),
					model.charts);
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						...
						{
							charts: newCharts,
							chartsToRead: A2(_elm_lang$core$Set$remove, _p19, model.chartsToRead)
						}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'Failure':
				...
				return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
			case 'ChangeScale':
				var _p22 = _elm_lang$core$String$toFloat(_p14._0);
				if (_p22.ctor === 'Err') {
					return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
				} else {
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							...
							{
								timeScale: _p22._0,
								charts: A2(_elm_lang$core$List$map, _user$project$Chart$clearChart, model.charts),
								chartsToRead: _elm_lang$core$Set$fromList(
									A2(
										_elm_lang$core$List$map,
										function (_) {
											return _.id;
			...
			case 'ToggleManual':
				var charts = A2(
					_elm_lang$core$List$map,
					_user$project$Chart$toggleManual(_p14._0),
					model.charts);
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
			...
			case 'ToggleNoReadings':
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							includeNoReadings: _elm_lang$core$Basics$not(model.includeNoReadings)
						}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'NewReading':
				var _p23 = A2(_elm_lang$core$Debug$log, 'New Reading', _p14._0);
				if (_p23.ctor === 'Nothing') {
					...
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								chartsToRead: A2(_elm_lang$core$Set$insert, _p23._0, model.chartsToRead)
							}),
						_1: _elm_lang$core$Platform_Cmd$none
					};
				}
			case 'RouteRed':
				var manual = A2(
					...
					A2(
						...
						model.charts));
				var levels = A2(_elm_lang$core$List$map, _user$project$Chart$chartToLevel, model.charts);
				var noreadings = model.includeNoReadings ? A2(
					_elm_lang$core$List$map,
					_elm_lang$core$Basics$fst,
					A2(
						_elm_lang$core$List$filter,
				...
				var low = A2(
					...
					A2(
						...
						function (_p25) {
							return function (l) {
								return _elm_lang$core$Native_Utils.eq(l, 'red') || _elm_lang$core$Native_Utils.eq(l, 'empty');
							}(
								_elm_lang$core$Basics$snd(_p25));
						},
						levels));
				return {
					ctor: '_Tuple2',
					_0: model,
					_1: _user$project$GMPorts$sendRoutes(
						{manual: manual, noreadings: noreadings, low: low})
				};
			case 'RouteYellow':
				var manual = A2(
					_elm_lang$core$List$map,
					...
					A2(
						...
						function (_p26) {
							return A2(
								...
								'noreadings',
								_elm_lang$core$Basics$snd(_p26));
						},
						levels)) : _elm_lang$core$Native_List.fromArray(
					[]);
				var low = A2(
					...
					A2(
						...
						function (_p27) {
							return function (l) {
								return _elm_lang$core$Native_Utils.eq(l, 'yellow') || (_elm_lang$core$Native_Utils.eq(l, 'red') || _elm_lang$core$Native_Utils.eq(l, 'empty'));
							}(
			...
			case 'FastTick':
				var setColors = A2(
					_elm_lang$core$List$map,
					function (c) {
						var _p28 = _user$project$Chart$chartToLevel(c);
						var i = _p28._0;
						var l = _p28._1;
						return _user$project$GMPorts$setColor(
							{ctor: '_Tuple3', _0: i, _1: l, _2: c.manual});
					},
					model.charts);
				return {
					ctor: '_Tuple2',
					_0: model,
					_1: _elm_lang$core$Platform_Cmd$batch(setColors)
				};
			default:
				var getReadings = function (toRead) {
					return _elm_lang$core$List$filterMap(
						function (c) {
							return (A2(_elm_lang$core$Set$member, c.id, toRead) || _elm_lang$core$Native_Utils.eq(c.lastPulled, _elm_lang$core$Maybe$Nothing)) ? _elm_lang$core$Maybe$Just(
								A3(
									_elm_lang$core$Task$perform,
									_user$project$Propane$Failure,
									_user$project$Propane$AddReadings(c.id),
									A3(
										_user$project$ReadingAPI$getByTank,
										c.id,
										_elm_lang$core$Maybe$Just(
											_elm_lang$core$Basics$round((60.0 * 60.0) * model.timeScale)),
										c.lastPulled))) : _elm_lang$core$Maybe$Nothing;
						});
				};
				return {
					ctor: '_Tuple2',
					_0: model,
					_1: _elm_lang$core$Platform_Cmd$batch(
						A2(getReadings, model.chartsToRead, model.charts))
				};
		}
	});
var _user$project$Propane$AddHub = function (a) {
	return {ctor: 'AddHub', _0: a};
};
	...
	return _elm_lang$core$Platform_Sub$batch(
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_user$project$GMPorts$markerDblClicked(_user$project$Propane$ToggleManual),
				A2(_elm_lang$core$Time$every, 1 * _elm_lang$core$Time$second, _user$project$Propane$SlowTick),
	...
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						...
						A2(
							_elm_lang$core$Basics_ops['++'],
							'Chart for Location ',
							_user$project$Chart$chartLocation(chart)))
					])),
				A2(
				_elm_lang$html$Html$div,
				_elm_lang$core$Native_List.fromArray(
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_user$project$Propane$renderVals(chart)
					]))
			]));
};
			...
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						...
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html$text('Include No Readings: '),
								A2(
								_elm_lang$html$Html$input,
								_elm_lang$core$Native_List.fromArray(
									[
										_elm_lang$html$Html_Attributes$type$('checkbox'),
										_elm_lang$html$Html_Events$onClick(_user$project$Propane$ToggleNoReadings)
									]),
								_elm_lang$core$Native_List.fromArray(
									[]))
							])),
						...
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html_Events$onClick(_user$project$Propane$RouteRed)
							]),
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html$text('Route to Red')
							])),
						A2(
						_elm_lang$html$Html$button,
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html_Events$onClick(_user$project$Propane$RouteYellow)
							]),
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html$text('Route to Yellow')
							]))
					])),
				A2(
				_elm_lang$html$Html$div,
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html$text('Hours to View: '),
						A2(
						_elm_lang$html$Html$input,
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html_Attributes$type$('number'),
								_elm_lang$html$Html_Attributes$placeholder('12'),
								_elm_lang$html$Html_Events$onInput(_user$project$Propane$ChangeScale)
							]),
						_elm_lang$core$Native_List.fromArray(
							[]))
					]))
	...
	main: _elm_lang$html$Html_App$program(
		{
			init: {
				ctor: '_Tuple2',
				_0: _user$project$Propane$initialModel,
				_1: A3(
					_elm_lang$core$Task$perform,
					_user$project$Propane$Failure,
					_user$project$Propane$AddHub,
					_user$project$HubAPI$getById(1))
			},
...
var Elm = {};
Elm['Propane'] = Elm['Propane'] || {};
_elm_lang$core$Native_Platform.addPublicModule(Elm['Propane'], 'Propane', typeof _user$project$Propane$main === 'undefined' ? null : _user$project$Propane$main);
